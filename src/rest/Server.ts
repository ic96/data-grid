...
import {QueryBody} from "../controller/QueryController";
        ...
        return new Promise(function (fulfill, reject) {
            try {
                ...
                that.rest.put('/dataset/:id',  function (req: restify.Request, res: restify.Response, next: restify.Next){
                    ...
                    Server.insightFacade.addDataset(req.params.id, dataStr).then(function (value: any) {
                       console.log(value);
                ...
                that.rest.del('/dataset/:id',  function (req: restify.Request, res: restify.Response, next: restify.Next){
                    ...
                    var id = req.params.id;
                    Server.insightFacade.removeDataset(id).then(function (value: any) {
                        res.json(value.code, value.body);
                        return next();
                    }).catch(function(err) {
                        res.json(err.code, err.body);
                ...
                that.rest.post('/query' ,function (req: restify.Request, res: restify.Response, next: restify.Next){
                    ...
                    Server.insightFacade.performQuery(req.body).then(function (value: any) {
                        res.json(value.code, value.body);
                        return next();
                    }).catch(function(err) {
                        res.json(err.code, err.body);
